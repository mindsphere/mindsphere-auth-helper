...
> [!NOTE]
> Version 4.0.0 adds support for Siemens Xcelerator (`*.siemens.app`) tenants, including the `gw_session` cookie, alongside the legacy `*.mindsphere.io` domains and the `SESSION` cookie.
